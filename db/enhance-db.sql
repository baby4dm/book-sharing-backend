...
INSERT INTO listings (id, owner_id, book_catalog_entry_id, condition_description, settlement_type, region, settlement_name, delivery_methods, status, created_at) VALUES
                                                                                                                                                                      ('b2222222-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'a1111111-0000-0000-0000-000000000002', 'Легкі потертості на обкладинці, всередині чисто.', NULL, NULL, NULL, ARRAY['PICKUP','MAIL']::text[], 'IN_EXCHANGE', now() - interval '30 days'),
                                                                                                                                                                      ('b2222222-0000-0000-0000-000000000002', '22222222-2222-2222-2222-222222222222', 'a1111111-0000-0000-0000-000000000001', 'Стан майже новий.',                                NULL, NULL, NULL, ARRAY['PICKUP']::text[],         'AVAILABLE',   now() - interval '20 days'),
                                                                                                                                                                      ('b2222222-0000-0000-0000-000000000003', '44444444-4444-4444-4444-444444444444', 'a1111111-0000-0000-0000-000000000004', 'Читана один раз, без поміток.',                    NULL, NULL, NULL, ARRAY['PICKUP','MAIL']::text[], 'AVAILABLE',   now() - interval '10 days'),
