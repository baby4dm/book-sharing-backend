...
INSERT INTO book_catalog_entries (id, isbn, title, author, description, genre, cover_url, source, created_at) VALUES
                                                                                                                  ('a1111111-0000-0000-0000-000000000001', '9789661376165', 'Кобзар',                       'Тарас Шевченко',      'Збірка поетичних творів.',                 'Поезія',    'https://covers.example.com/kobzar.jpg', 'GOOGLE_BOOKS', now() - interval '170 days'),
                                                                                                                  ('a1111111-0000-0000-0000-000000000002', '9786171253689', 'Затьмарення',                  'Філіп К. Дік',        'Науково-фантастичний роман.',              'Фантастика','https://covers.example.com/scanner.jpg', 'GOOGLE_BOOKS', now() - interval '160 days'),
                                                                                                                  ('a1111111-0000-0000-0000-000000000003', '9786176791312', 'Хроніки Амбера',               'Роджер Желязни',      'Фентезійна сага.',                         'Фентезі',   'https://covers.example.com/amber.jpg', 'GOOGLE_BOOKS', now() - interval '140 days'),
                                                                                                                  ('a1111111-0000-0000-0000-000000000004', '9786177544996', 'Атомні звички',                'Джеймс Клір',         'Книга про формування корисних звичок.',    'Нон-фікшн', 'https://covers.example.com/habits.jpg', 'GOOGLE_BOOKS', now() - interval '100 days'),
                                                                                                                  ('a1111111-0000-0000-0000-000000000005', '9786178012345', 'Місто',                        'Валер''ян Підмогильний','Класика української прози.',             'Класика',   'https://covers.example.com/misto.jpg', 'MANUAL', now() - interval '80 days');
