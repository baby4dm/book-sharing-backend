...
-- USERS
-- ==========================================================
INSERT INTO users (id, google_id, email, name, avatar_url, settlement_type, region, settlement_name, bio, rating_avg, books_taken, books_returned_on_time, books_overdue, books_damaged, books_given, role, status, created_at) VALUES
                                                                                                                                                                                                                                    ('11111111-1111-1111-1111-111111111111', 'g-oleh',    'oleh.k@example.com',    'Олег Коваленко',   'https://i.pravatar.cc/150?u=oleh',    'CITY', 'Київська область',         'Київ',    'Люблю фантастику і детективи.', 4.80, 5, 5, 0, 0, 8, 'USER', 'ACTIVE', now() - interval '180 days'),
                                                                                                                                                                                                                                    ('22222222-2222-2222-2222-222222222222', 'g-maria',   'maria.s@example.com',   'Марія Шевченко',   'https://i.pravatar.cc/150?u=maria',   'CITY', 'Львівська область',        'Львів',   'Класика і поезія.',             4.50, 3, 2, 1, 0, 4, 'USER', 'ACTIVE', now() - interval '150 days'),
                                                                                                                                                                                                                                    ('33333333-3333-3333-3333-333333333333', 'g-ivan',    'ivan.p@example.com',    'Іван Петренко',    'https://i.pravatar.cc/150?u=ivan',    'CITY', 'Одеська область',          'Одеса',   'Нон-фікшн та саморозвиток.',    3.90, 6, 4, 2, 1, 2, 'USER', 'ACTIVE', now() - interval '120 days'),
                                                                                                                                                                                                                                    ('44444444-4444-4444-4444-444444444444', 'g-anna',    'anna.d@example.com',    'Анна Дмитренко',   'https://i.pravatar.cc/150?u=anna',    'CITY', 'Харківська область',       'Харків',  'Читаю все підряд.',             5.00, 2, 2, 0, 0, 6, 'USER', 'ACTIVE', now() - interval '90 days'),
                                                                                                                                                                                                                                    ('55555555-5555-5555-5555-555555555555', 'g-taras',   'taras.m@example.com',   'Тарас Мельник',    'https://i.pravatar.cc/150?u=taras',   'CITY', 'Дніпропетровська область', 'Дніпро',  'Іноді забуваю повертати книги)', 3.20, 4, 1, 3, 1, 1, 'USER', 'RESTRICTED', now() - interval '200 days'),
                                                                                                                                                                                                                                    ('66666666-6666-6666-6666-666666666666', NULL,        'moderator@bookshare.ua','Модератор Сервісу','https://i.pravatar.cc/150?u=moderator', 'CITY', 'Київська область',        'Київ',  NULL, 0, 0, 0, 0, 0, 0, 'MODERATOR', 'ACTIVE', now() - interval '365 days');
...
INSERT INTO book_catalog_entries (id, isbn, title, author, description, genre, cover_url, source, created_at) VALUES
                                                                                                                  ...
                                                                                                                  ('a1111111-0000-0000-0000-000000000002', '9786171253689', 'Затьмарення',                  'Філіп К. Дік',        'Науково-фантастичний роман.',              'Фантастика','https://covers.openlibrary.org/b/isbn/9780156767293-L.jpg?default=false', 'GOOGLE_BOOKS', now() - interval '160 days'),
                                                                                                                  ('a1111111-0000-0000-0000-000000000003', '9786176791312', 'Хроніки Амбера',               'Роджер Желязни',      'Фентезійна сага.',                         'Фентезі',   'https://covers.openlibrary.org/b/isbn/9780380014405-L.jpg?default=false', 'GOOGLE_BOOKS', now() - interval '140 days'),
                                                                                                                  ('a1111111-0000-0000-0000-000000000004', '9786177544996', 'Атомні звички',                'Джеймс Клір',         'Книга про формування корисних звичок.',    'Нон-фікшн', 'https://covers.openlibrary.org/b/isbn/9780735211292-L.jpg?default=false', 'GOOGLE_BOOKS', now() - interval '100 days'),
...
-- LISTINGS
-- ==========================================================
-- Останнє оголошення (Хроніки Амбера, власник Іван з Одеси) навмисно
-- має OVERRIDE локації - демонструє фічу "книга зараз в іншому місці":
-- Іван тимчасово в селі, вказує це явно замість свого профілю.
INSERT INTO listings (id, owner_id, book_catalog_entry_id, condition_description, settlement_type, region, settlement_name, delivery_methods, status, created_at) VALUES
                                                                                                                                                                      ('b2222222-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'a1111111-0000-0000-0000-000000000002', 'Легкі потертості на обкладинці, всередині чисто.', 'CITY', 'Київська область',   'Київ',   ARRAY['PICKUP','MAIL']::text[], 'IN_EXCHANGE', now() - interval '30 days'),
                                                                                                                                                                      ('b2222222-0000-0000-0000-000000000002', '22222222-2222-2222-2222-222222222222', 'a1111111-0000-0000-0000-000000000001', 'Стан майже новий.',                                'CITY', 'Львівська область',  'Львів',  ARRAY['PICKUP']::text[],         'AVAILABLE',   now() - interval '20 days'),
                                                                                                                                                                      ('b2222222-0000-0000-0000-000000000003', '44444444-4444-4444-4444-444444444444', 'a1111111-0000-0000-0000-000000000004', 'Читана один раз, без поміток.',                    'CITY', 'Харківська область', 'Харків', ARRAY['PICKUP','MAIL']::text[], 'AVAILABLE',   now() - interval '10 days'),
                                                                                                                                                                      -- ЦЕ оголошення навмисно НЕ збігається з профілем власника (Іван з Одеси) -
                                                                                                                                                                      -- демонструє override: книга/передача зараз в ІНШОМУ населеному пункті
                                                                                                                                                                      ('b2222222-0000-0000-0000-000000000004', '33333333-3333-3333-3333-333333333333', 'a1111111-0000-0000-0000-000000000003', 'Є підкреслення олівцем на кількох сторінках.',     'VILLAGE', 'Одеська область', 'Затока', ARRAY['MAIL']::text[], 'RESERVED', now() - interval '5 days');
...
INSERT INTO reviews (exchange_id, author_id, target_id, rating, comment, created_at) VALUES
                                                                                         ('d4444444-0000-0000-0000-000000000003', '22222222-2222-2222-2222-222222222222', '44444444-4444-4444-4444-444444444444', 5, 'Чудовий читач, повернула книгу в ідеальному стані і навіть раніше терміном!', now() - interval '12 days'),
...
-- ==========================================================
-- ДОДАТКОВІ 50 КНИГ (реальні обкладинки з Open Library API)
...
--
-- Власника кожного оголошення обираємо через підзапит
-- (SELECT id FROM users ORDER BY random() LIMIT 1) - спрацює
-- незалежно від того, які саме id користувачів реально є в БД
-- (сумісно з UUID-ами users вище, бо вони вже вставлені до цього
-- моменту в тому самому файлі).
-- ==========================================================
...
WITH new_books (title, author, genre, isbn) AS (
    VALUES
        ...
        ('Олівер Твіст', 'Чарльз Діккенс', 'Класика', '9780141439747'),
        ('Джейн Ейр', 'Шарлотта Бронте', 'Класика', '9780141441146'),
        ('Грозовий Перевал', 'Емілі Бронте', 'Класика', '9780141439556'),
        ...
        ('Гордість і упередження', 'Джейн Остін', 'Класика', '9780141439518'),
        ...
        ('Портрет митця замолоду', 'Джеймс Джойс', 'Класика', '9780141182816'),
...
INSERT INTO listings (id, owner_id, book_catalog_entry_id, condition_description, settlement_type, region, settlement_name, delivery_methods, status, created_at)
SELECT
    gen_random_uuid(),
    owner.id,
    inserted_books.id,
    'Гарний стан, читалась акуратно',
    owner.settlement_type,
    owner.region,
    owner.settlement_name,
    ARRAY['PICKUP', 'MAIL']::text[],
    'AVAILABLE',
    now() - (random() * interval '30 days')
FROM inserted_books
         CROSS JOIN LATERAL (
    SELECT id, settlement_type, region, settlement_name
